 ...
 */
function xmldb_qtype_patternessay_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2013021201) {
        ...
        upgrade_plugin_savepoint(true, 2013021201, 'qtype', 'patternessay');
    }
    ...
    if ($oldversion < 2015101300) {
        ...
        upgrade_plugin_savepoint(true, 2015101300, 'qtype', 'patternessay');
    }
    ...
    if ($oldversion < 2016010400) {
        ...
        // Question savepoint reached.
        upgrade_plugin_savepoint(true, 2016010400, 'qtype', 'patternessay');
    }
    ...
    if ($oldversion < 2016012600) {
        ...
        // patternessay savepoint reached.
        upgrade_plugin_savepoint(true, 2016012600, 'qtype', 'patternessay');
    }
    ...
    if ($oldversion < 2016020500) {
        ...
        // Question savepoint reached.
        upgrade_plugin_savepoint(true, 2016020500, 'qtype', 'patternessay');
    }

    if ($oldversion < 2019021800) {
        $table = new xmldb_table('qtype_patternessay');
        if ($dbman->table_exists($table)) {
            ...
            if ($dbman->field_exists($table, $field)) {
                ...
                $DB->set_field('qtype_patternessay', 'applydictionarycheck', qtype_patternessay_spell_checker::DO_NOT_CHECK_OPTION,
                        ['applydictionarycheck' => 0]);
                $DB->set_field('qtype_patternessay', 'applydictionarycheck', get_string('iso6391', 'langconfig'),
                        ['applydictionarycheck' => 1]);
            }
        }
        upgrade_plugin_savepoint(true, 2019021800, 'qtype', 'patternessay');
    }
    ...
    if ($oldversion < 2019031800) {
        ...
        upgrade_plugin_savepoint(true, 2019031800, 'qtype', 'patternessay');
    }
    ...
    if ($oldversion < 2019032700) {
        ...
        if ($dbman->table_exists($table)) {
            ...
            $DB->set_field('qtype_patternessay', 'applydictionarycheck', $matched, ['applydictionarycheck' => $defaultlanguage]);
        }
        upgrade_plugin_savepoint(true, 2019032700, 'qtype', 'patternessay');
    }

    if ($oldversion < 2019071200) {

        // Define field sentencedividers to be added to qtype_patternessay.
        $table = new xmldb_table('qtype_patternessay');
        ...
        // patternessay savepoint reached.
        upgrade_plugin_savepoint(true, 2019071200, 'qtype', 'patternessay');
    }

    if ($oldversion < 2019091000) {

        // Define field modelanswer to be added to qtype_patternessay.
        $table = new xmldb_table('qtype_patternessay');
        ...
        // patternessay savepoint reached.
        upgrade_plugin_savepoint(true, 2019091000, 'qtype', 'patternessay');
    }
