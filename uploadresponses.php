...
class upload_form extends moodleform {
    protected function definition() {
        ...
        $this->_form->addElement('filepicker', 'responsesfile',
                ...
                ['accepted_types' => \qtype_patternessay\testquestion_import_helper::ACCEPTED_TYPES]);
        ...
        $this->_form->addElement('submit', 'submitbutton',
                get_string('testquestionuploadtheseresponses', 'qtype_patternessay'));
    }
    ...
    public function validation($data, $files) {
        ...
        foreach ($attachfiles as $file) {
            if (!in_array($file->get_filename(), ['.', '..'])) {
                ...
                $errcase = \qtype_patternessay\testquestion_responses::validate_upload_file($tmpfilepath);
            }
        }
