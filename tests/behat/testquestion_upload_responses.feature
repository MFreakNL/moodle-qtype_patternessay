...
Feature: Test uploading test responses in the pattern match test this question feature
  ...
  Scenario: Upload responses to test with.
    ...
    When I upload "question/type/patternessay/tests/fixtures/uploadreponses.csv" file to "Marked responses" filemanager
  ...
  Scenario: Test error message if the file doesn't meet the condition.
    ...
    When I upload "question/type/patternessay/tests/fixtures/testerrorcase1.xls" file to "Marked responses" filemanager
    And I press "Upload these responses"
    ...
    When I upload "question/type/patternessay/tests/fixtures/testerrorcase2.csv" file to "Marked responses" filemanager
    And I press "Upload these responses"
    ...
    When I upload "question/type/patternessay/tests/fixtures/testerrorcase3.csv" file to "Marked responses" filemanager
    And I press "Upload these responses"
    ...
    When I upload "question/type/patternessay/tests/fixtures/testerrorcase4.csv" file to "Marked responses" filemanager
    And I press "Upload these responses"
    ...
    When I upload "question/type/patternessay/tests/fixtures/testerror.csv" file to "Marked responses" filemanager
    And I press "Upload these responses"
    Then I should see "The file requires at least two rows (the first row is the header row, the second row onwards for responses)."
  ...
  Scenario: Test upload XLSX file type.
    Given I upload "question/type/patternessay/tests/fixtures/testreponses_xlsx_error_1.xlsx" file to "Marked responses" filemanager
    When I press "Upload these responses"
    Then I should see "The file requires at least two columns (the first column for expected marks, the second column for responses)."

    When I upload "question/type/patternessay/tests/fixtures/testreponses_xlsx_normal.xlsx" file to "Marked responses" filemanager
    And I press "Upload these responses"
