...
$string['filloutoneanswer'] = 'Use Pattern essay syntax to describe correct answers. You must provide at least one possible answer. Answers left blank will not be used. The first matching answer will be used to determine the score and feedback.';
...
$string['ie_nomatchfound'] = 'Error in pattern essay code.';
...
$string['pluginname'] = 'Pattern essay';
...
$string['pluginnameadding'] = 'Adding a Pattern essay question';
$string['pluginnameediting'] = 'Editing a Pattern essay question';
$string['pluginnamesummary'] = 'Allows a short response of one or a few sentences that is graded by comparing against various model answers, which are described using the OU\'s pattern essay syntax.';
$string['privacy:metadata:preference:pagesize'] = 'Number of pattern essay question attempts to show per page.';
...
$string['testquestionformerror_incorrectquestionid'] = 'Incorrect question id, or not a pattern essay question.';
